...
set geodmsversion=GeoDMS12.0.0
...
for %%r in (%results%) do (
	C:\%pf%\ObjectVision\%geodmsversion%\GeoDmsRun.exe %config%\main.dms /tabulation/gen_results_per_popgrid_tot/%%r/country_agg /tabulation/gen_results_per_popgrid_tot/%%r/region_agg
	C:\%pf%\ObjectVision\%geodmsversion%\GeoDmsRun.exe %config%\main.dms /tabulation/gen_results_per_popgrid_urb/%%r/country_agg /tabulation/gen_results_per_popgrid_urb/%%r/region_agg
)
