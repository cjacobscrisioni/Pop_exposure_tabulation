...
for %%r in (%results%) do (
	C:\%pf%\ObjectVision\%geodmsversion%\GeoDmsRun.exe %config%\main.dms /tabulation/results_per_popgrid/%%r/country_agg /tabulation/results_per_popgrid/%%r/region_agg
)
